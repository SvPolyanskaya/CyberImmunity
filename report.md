...
![](https://github.com/SvPolyanskaya/CyberImmunity/blob/Robot-in-Pharmacy/Контекст%1.png)
...
-	всё остальное из варианта 1.
  ...
  ![](https://github.com/SvPolyanskaya/CyberImmunity/blob/Robot-in-Pharmacy/Контекст%2.png)
