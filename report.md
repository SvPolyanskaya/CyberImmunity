...
- [Упражнение: Анализ векторов атак и эффекта.](#Упражнение:-Анализ-векторов-атак-и-эффекта-безопасности.)
...
|10. Приводы|	управляют захватами робота для реализации рассчитанных траекторий и механических воздействий на субстанции (в т.ч. измельчение и перемешивание)	||
 ### Упражнение
Изобразите развитие атаки через другие скомпрометированные компоненты (по одному в сценарии)
